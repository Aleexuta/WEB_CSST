...
const navLi=document.querySelectorAll("nav .meniu ul li");
...
function displayMenu() {
   ...
   // x.style.display="block";
    ...
    var y = document.getElementById("nc");
   // y.style.display="block";
    y.style.visibility="visible";
    y.style.opacity="1";
    y.style.width="15em";

    var z = document.getElementById("mobile-cta");
    //z.style.display="none";
    z.style.visibility="hidden";
    x.style.opacity="1";

    var z1 = document.getElementById("mobile-exit");
